  ...
  return (
    <div className="space-y-8">
      ...
      <div>
        ...
        <p className="text-gray-700">Manage your account preferences and custom categories</p>
      </div>
      
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-6">
          <div className="flex items-center justify-between mb-6">
            <h3 className="text-lg font-semibold text-gray-900">Your Custom Categories</h3>
          ...
          {categories && categories.length > 0 ? (
            ...
            <div className="text-center py-8">
              ...
              <p className="text-gray-600 text-sm mt-1">Create custom categories to organize your transactions</p>
            </div>
          )}
        </div>
